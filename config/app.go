...
type Config struct {
	App struct {
		Name  string `env:"APP_NAME" envDefault:"cinema"`
	...
	DB struct {
		...
		Username          string `env:"DB_USERNAME" env-default:"username"`
		Password          string `env:"DB_PASSWORD" env-default:"7h1$.P4A$w0Rd.4gpnSWCjyAygwD18pgA1awIJvuUgQN00M"`
		Database          string `env:"DB_NAME" env-default:"main_db"`
