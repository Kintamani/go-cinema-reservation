...
```bash
docker compose exec skeleton-golang migrate -path databases/migrations -database "postgres://DB_USERNAME:DB_PASSWORD@DB_HOST:DB_PORT/DB_NAME?sslmode=disable" up
```
